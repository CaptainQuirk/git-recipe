...
build-docker:
	@docker-compose build git-recipe
...
ifndef CONTAINER_TEST
	...
	@container-structure-test test --image registry.gitlab.com/leonardmessier/shef/recipes/git-recipe:1.0.0 --config tests/acceptance/cst.yml
